            ...
            <table class="table table-bordered">
                ...
                <tbody class="table table-bordered">
                    <tr v-for="item in list" :key="item.id">
                        ...
                        <td>
                            <div>
                                <!-- <button class="btn btn-group listbutton">
                            ...
                            <button v-on:click="completeTask(item.id)" type="button"
                                class="btn btn-group listbutton">Completed
                            </button>
                            <button v-on:click="completeTask(item.id)" type="button"
                                class="btn btn-group listbutton">Completed
                            </button>
                            <button v-on:click="deleteTask(item.id)" class="btn btn-group listbutton">Delete
                            </button> -->
                                <div class="button-list">
                                    <button v-if="item.status==0">
                                        <router-link :to="{ name: 'Update', params: { taskId: item.id }}">Edit
                                        </router-link>
                                        <!-- <router-link :to="'/update/'+item.id">Edit</router-link> -->
                                    </button>
